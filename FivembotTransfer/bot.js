(async () => {
    ...
    const conn = await mongoose.connect(credentialManager.mongoDB, {
...
// roleCreate roleDelete roleUpdate messageDelete messageUpdate channelCreate channelDelete channelUpdate
